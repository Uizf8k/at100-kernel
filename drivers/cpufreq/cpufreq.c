...
#define CPUMVMIN 700
#if defined(CONFIG_TEGRA_OVERCLOCK)
int cpufrequency[FREQCOUNT] = { 216000, 312000, 456000, 608000, 760000, 816000, 912000, 1000000, 1200000, 1408000, 1504000 };
#else
int cpufrequency[FREQCOUNT] = { 216000, 312000, 456000, 608000, 750000, 760000, 816000, 912000, 1000000, 1200000 };
#endif

#if defined(CONFIG_TEGRA_OVERCLOCK)
int cpuvoltage[FREQCOUNT] = {750, 775, 800, 825, 875, 900, 925, 950, 1025, 1175, 1275, 1325};
#else
